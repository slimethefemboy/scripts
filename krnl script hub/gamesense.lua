-- Modded GameSense v1.00 (Check back on the thread for newer modded versions)
...
wait(.5)
Notification({Title='Modded By';Text='HamstaGang';Duration=4;Icon='rbxassetid://1004145070'})
wait(.5)
